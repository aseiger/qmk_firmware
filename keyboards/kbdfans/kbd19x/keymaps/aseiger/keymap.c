...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all( /* Base */
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,KC_DEL, KC_BSPC,    KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, \
  ...
  [1] = LAYOUT_all( /* Func */
    ...
    _______, _______, _______,                            KC_MPLY,                   _______, KC_TRNS, _______,       KC_MPRV, KC_VOLD, KC_MNXT,    RGB_M_G, RGB_M_T, RGB_SPD  \
  ),
};
