...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_regular_shift_regular_backspace(
        KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC,           KC_NUM,  KC_PMNS,   KC_PPLS,
    ...
    [_FN2] = LAYOUT_ansi_regular_shift_regular_backspace(
        ...
        _______,   _______, _______, EEPROM_RESET, RESET, HPT_TOG, HPT_FBK, HPT_BUZ, _______, _______, _______, _______, _______, _______,   _______, _______, _______,
